        ...
        onPress={()=> navigation.navigate("OfflineOrders")}
          style={{
            ...
            justifyContent:'center'
              ...
              <Text style={{color:APPCOLORS.WHITE, fontSize:18, fontWeight:'bold'}}>Check Offline Orders</Text>
          </TouchableOpacity>
        <View
          style={{
        ...
        <TouchableOpacity
          ...
          <Text
...

            {
                      ...
                      <View 
                        ...
                        <View
                          ...
                          <View
                            ...
                            <View>
                              <Text
                                style={{color: APPCOLORS.BLACK, fontWeight: 'bold'}}>
                                Last Order
                              </Text>
                            ...
                            <View>
                              ...
                              <Text>Rs {Number(JSON.parse(item.current_balance)).toFixed(2) }</Text>
                            </View>
                          </View>
                        </View>
                      </View>
                ...
                <Text style={{alignItems:'center', justifyContent:'center', color:APPCOLORS.BLACK, fontSize:20}}>
                    No Customer Found
                </Text>
                </View>
            }
