        ...
        <View style={{ flex: 1, backgroundColor: APPCOLORS.WHITE }}>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
                ...
                <View style={{
                    ...
                    />
                    <AppText
                        title={`${now.toLocaleString('default', { month: 'long' })} ${currentYear}`}
                        titleSize={1.8}
                        ...
                        return (
                            <TouchableOpacity
                                ...
                                style={{
                                    ...
                                    backgroundColor: isCurrentDay ? APPCOLORS.Primary : (isPast ? '#E0E0E0' : '#F5F5F5'),
                            ...
                            >
                                <AppText
                                    title={day.toString()}
                                    titleColor={isCurrentDay ? APPCOLORS.WHITE : APPCOLORS.Secondary}
                                    titleSize={1.6}
